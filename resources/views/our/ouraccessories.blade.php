        ...
        <div class="w-8/12 pt-20 pl-20 rounded-lg">
                ...
                <form action="" method="post" class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="body" id="body" class="bg-gray-100 border-2 w-11/12 p-4 rounded-lg h-16" placeholder="e.g. collar"></textarea>
                    </div>

                    <div>
                        <button type="submit" class="bg-white text-black  px-4 py-2 rounded font-medium">search</button>
                    </div>
                </form>
